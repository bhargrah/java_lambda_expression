...
public class MainComparator {
    ...
    public static void main(String... args) {
        ...
        Comparator<Employee> cmpAge = (p1, p2) -> p2.getAge() - p1.getAge();   // leveraging compare method
        Comparator<Employee> cmpFirstName = (p1, p2) -> p1.getFirstName().compareTo(p2.getFirstName()); // leveraging compare method
        Comparator<Employee> cmpLastName = (p1, p2) -> p1.getLastName().compareTo(p2.getLastName()); // leveraging compare method
        ...
        Comparator<Employee> cmp = Comparator.comparing(Employee::getLastName).thenComparing(Employee::getFirstName).thenComparing(Employee::getAge);
