...
public class MainAPICollectionMap {
  ...
  static List<Person> people = new ArrayList<Person>(List.of(p1, p2, p3, p4, p5, p6, p7, p8, p9));
  ...
  private static void putIfAbsent(Map<City, List<Person>> map) {
    ...
    System.out.println(
        map.get(paris) == null ? "No entry present for " + paris : "Entry present for " + paris);
    ...
    System.out.println(
        "People from Shanghai : " + map.getOrDefault(shanghai, Collections.EMPTY_LIST));
    System.out.println(
